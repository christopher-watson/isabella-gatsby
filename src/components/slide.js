  ...
  render() {
    return (
      ...
      {/* <li>Drop In - $25/class</li>
                    ...
                    <li>Unlimited $164/month</li>
                    <li>2x/wk $139/month</li>
